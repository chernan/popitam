...
#define MAX_COMBI                       100          // max de combinaisons possibles pour les modifs pr�vues
...
#define MIN_PRESCORE                      4.0        // (float) PAS UTILISE ratio par rapport au nombre d'aa pr�sum�s du peptide parent
                                                     // pour le scoring (2 signifie nbrePr�sum� / 2)
